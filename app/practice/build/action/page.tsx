...
function ActionPageContent() {
  ...
  const handleNext = () => {
    saveToDraft();
    router.push(`/practice/build/result?questions=${queryString}&index=${currentIndex}`);
  };
  ...
  const guide = STAR_GUIDES.action;
  ...
  return (
    <main className="min-h-screen bg-background p-16 md:p-24">
      <div className="max-w-3xl mx-auto space-y-24">
        ...
        <ProgressBar current={3} total={4} labels={STAR_STEPS.map((s) => s.charAt(0).toUpperCase() + s.slice(1))} />
